    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Daftar Outlet Active</h1>
            </div>
        </div>
    </div>
        ...
        <div class="card" style="box-shadow: rgba(0, 0, 0, 0.12) 0px 1px 6px 0px;">
            <div class="card-body py-4">
                <div class="table-responsive">
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="tableOutletActive">
                        <thead>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            $('#tableOutletActive').DataTable({
                processing: true,
                serverSide: false,
                ajax: {
                    url: "/admin/getDataoutletActive",
                    dataType: "JSON",
                },
                language: {
                    processing: "Loading..."
