        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Daftar Brand Owner Rejected</h1>
                </div>
            </div>
        </div>
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="tableBrandOwner">
                            <thead>
                                <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-100px text-dark">Category</th>
                            ...
                            return `<div class="d-flex align-items-center">
                                        <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                            <div class="symbol-label">
                                                <img src="{{ asset('storage/user_owner/logo_brand/${imagePath}') }}" class="w-100"/>
                                            </div>
                                        </div>
                        ...
                        render: function(data, type, row) {
                            return `<div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton${row.id}">
                                            <li>
                                                <button onclick="window.location.href = 'detail-user-brand/${row.slug}'" class="dropdown-item p-2 ps-5" style="cursor: pointer">
