    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                @endif
                <form action="{{ route('admin.admin_update_new_brands', ['brand' => $brand->slug]) }}" method="POST" enctype="multipart/form-data" class="form d-flex flex-column flex-lg-row">
                    @csrf
                                    ...
                                    <div class="card card-flush py-4" style="box-shadow: rgba(0, 0, 0, 0.12) 0px 1px 6px 0px;">
                                        ...
                                        <div class="card-body pt-0">
                                            <div class="row fv-row">
                                                ...
                                                <input type="hidden" name="brand_image_path" value="{{ $brand->brand_image_path }}">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3" data-kt-image-input="true">
                                                        ...
                                                        <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Ubah Gambar">
                                                            ...
                                                            <input type="file" name="logo_brand" accept=".png, .jpg, .jpeg"/>
                                                        ...
                                                        <div class="input-group">
                                                            <select class="form-select mb-2" data-control="select2" data-placeholder="Pilih Kategori" data-allow-clear="true" name="brand_category_code" required>
                                                                ...
                                                                @foreach($categories as $kategori)
                                                                    <option value="{{ $kategori->brand_category_code }}" {{ $brand->brand_category_code == $kategori->brand_category_code ? 'selected' : '' }}>
                                                                        {{ $kategori->brand_category_name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="mb-10 fv-row">
                                                                ...
                                                                <input type="text" name="brand_name" class="form-control mb-2" id="brand_name" placeholder="Masukan Nama Brand" value="{{ $brand->brand_name }}" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="mb-10 fv-row">
                                                                <label class="required form-label" style="color:#31353B!important;font-size: 1rem;font-weight: 700">Slug</label>
                                                                <input type="text" name="slug" class="form-control mb-2" id="slug" style="background-color: #e2e2e2;cursor: not-allowed;" value="{{ $brand->slug }}" readonly>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-10 fv-row">
                                                        ...
                                                        <input type="text" name="no_hp_brand" class="form-control mb-2" id="no_hp_brand" value="{{ $brand->no_hp }}" required/>
                                                    ...
                                                    <div class="mb-10 fv-row">
                                                        ...
                                                        <input type="text" name="facebook_brand" class="form-control mb-2" id="facebook_brand" value="{{ $brand->facebook }}"/>
                                                    </div>
                                                    <div class="mb-10 fv-row">
                                                        <label class="form-label" style="color:#31353B!important;font-size: 1rem;font-weight: 700">Link Youtube Brand</label>
                                                        <input type="text" name="youtube_brand" class="form-control mb-2" id="youtube_brand" value="{{ $brand->youtube }}"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="mb-10 fv-row">
                                                        <label class="required form-label" style="color:#31353B!important;font-size: 1rem;font-weight: 700">Whatsapp Brand</label>
                                                        <input type="text" name="whatsapp_brand" class="form-control mb-2" id="whatsapp_brand" value="{{ $brand->whatsapp }}" required/>
                                                    ...
                                                    <div class="mb-10 fv-row">
                                                        ...
                                                        <input type="text" name="instagram_brand" class="form-control mb-2" id="instagram_brand" value="{{ $brand->instagram }}"/>
                                                    </div>
                                                    <div class="mb-10 fv-row">
                                                        <label class="form-label" style="color:#31353B!important;font-size: 1rem;font-weight: 700">Link Tiktok Brand</label>
                                                        <input type="text" name="tiktok_brand" class="form-control mb-2" id="tiktok_brand" value="{{ $brand->tiktok }}"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="mb-10 fv-row">
                                                    ...
                                                    <input type="text" name="website_brand" class="form-control mb-2" id="website_brand" value="{{ $brand->website }}"/>
                                                </div>
                                            </div>
                                            <div>
                                                <label class="required form-label" style="color:#31353B!important;font-size: 1rem;font-weight: 700">Brand Description</label>
                                                <textarea name="brand_description" class="form-control mb-2" rows="4" required>{{ $brand->brand_description }}</textarea>
    ...
    <script>
        $(document).ready(function() {
            ...
            var handleSearchNoHp_brand = _.debounce(function() {
                var brand_Code         = {{ $brand->brand_code }}
                ...
                if (noHP_brand.length >= 3) {
                    $.ajax({
                        url: "/admin/validate_Edit_NoHp_brand",
                        type: "GET",
                        data: {
                            'no_hp': noHP_brand,
