									...
									<div class="card card-flush py-4" style="box-shadow: rgba(0, 0, 0, 0.12) 0px 1px 6px 0px;">
										...
										<div class="card-body pt-0">
											...
											<div class="mb-10 fv-row">
												...
												<input type="text" name="username" class="form-control mb-2 username" placeholder="asep123">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-10 fv-row">
                                                        ...
                                                        <input type="email" name="email" class="form-control mb-2 email" placeholder="asep123@gmail.com">
									...
									<div class="card card-flush py-4" style="box-shadow: rgba(0, 0, 0, 0.12) 0px 1px 6px 0px;">
										...
										<div class="card-body pt-0">
                                            <div class="mb-10 fv-row">
                                                ...
                                                <input type="text" name="nama_outlet" class="form-control mb-2" id="nama_outlet" placeholder="Maitea Cibinong">
                                            </div>
                                            <div class="mb-10 fv-row">
